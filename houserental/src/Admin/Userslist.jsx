...
function Userslist() {
    ...
    const fetchBookings = async () => {
      try {
        const response = await axios.get(
          "http://localhost/houserentbackend/controllers/api/admin/get/apartbook.php"
        );
  ...
  const handleSaveClick = async () => {
    try {
      await axios.put(
        "http://localhost/houserentbackend/controllers/api/admin/put/apartupdate.php",
        editFormData
      );
  ...
  const handleDelete = async (id) => {
    try {
      const response = await axios.post(
        "http://localhost/houserentbackend/controllers/api/admin/delete/apartdel.php",
        { id }
      );
