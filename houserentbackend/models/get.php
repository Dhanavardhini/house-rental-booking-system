...
{ 
    ...
    public function apartmentbookget() 
    {
        
        $query = "SELECT * FROM bookapart ";
    ...
    public function villabookget() 
    {
        
        $query = "SELECT * FROM bookvilla ";
